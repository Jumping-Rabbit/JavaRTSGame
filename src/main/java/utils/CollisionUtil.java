...
public class CollisionUtil {
    ...
    public static boolean RectCircleCollision(double x1, double y1, double r1, Rectangle2D rect) {
        return RectCircleCollision(x1, y1, r1, DTL(rect.getMinX()), DTL(rect.getMinY()), DTL(rect.getWidth()), DTL(rect.getHeight()));
    }
