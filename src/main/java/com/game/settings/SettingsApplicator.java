...
//        }
  ...
  protected static void setBGMVolume(int value) {
  
  }
  
  protected static void setMasterVolume(int value) {
  
  }
  
  protected static void setSFXVolume(int value) {
  
  }
  
  protected static void setAntialiasing(boolean value) {
  
  }
  
  protected static void setGraphicsQuality(EnumSetting value) {
