...
public enum Actions {
    ...
    GET_CONTROL_GROUP_1("get control group 1"),
    ...
    public static void init() {
        ...
        JsonNode root = objectMapper.readTree(new File("core/resources/keyBinds.json"));
        ...
        objectMapper.writerWithDefaultPrettyPrinter().writeValue(new File("core/resources/keyBinds.json"), root);
    }
